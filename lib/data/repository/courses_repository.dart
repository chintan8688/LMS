...
abstract class CoursesRepository {
  ...
  Future bookRequest(int courseId, String notes);
}
...
class CoursesRepositoryImpl extends CoursesRepository {
  ...
  Future addFavoriteCourse(int courseId) {
    ...
    return _apiProvider.addFavBook(courseId);
  }

  @override
  Future deleteFavoriteCourse(int courseId) {
    //return _apiProvider.deleteFavoriteCourse(courseId);
    return _apiProvider.deleteFavBook(courseId);
  }
  ...
  @override
  Future bookRequest(int courseId, String notes) {
    return _apiProvider.requestBook(courseId, notes);
  }
}
