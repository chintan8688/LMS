...
class QuizBean {
  ...
  QuizBean({this.title, this.questions});

  factory QuizBean.fromJson(Map<String, dynamic> json) =>
      _$QuizBeanFromJson(json);
}
...
class QuestionBean {
  ...
  QuestionBean({this.title, this.type, this.answers, this.selectedSingle});
...
class AnswerBean {
  ...
  AnswerBean({
    ...
    this.isTrue,
    this.listCorrect,
    this.selectedValueCheckbox,
  });

  factory AnswerBean.fromJson(Map<String, dynamic> json, String type,
          List<bool> correct, List<bool> selected) =>
      _$AnswerBeanFromJson(json, type, correct, selected);
}
