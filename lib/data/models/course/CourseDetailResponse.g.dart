...
CourseDetailResponse _$CourseDetailResponseFromJson(Map<String, dynamic> json) {
  return CourseDetailResponse(
      ...
      categories_object: (json['categories_object'] as List)
          ...
          ?.toList(),
      quizes: (json['quiz'] as List)
          .map((e) =>
              e == null ? null : QuizBean.fromJson(e as Map<String, dynamic>))
          ?.toList());
}
...
QuizBean _$QuizBeanFromJson(Map<String, dynamic> json) {
  return QuizBean(
...
QuestionBean _$QuestionBeanFromJson(Map<String, dynamic> json) {
  ...
  if (json["type"] == "multi_choice") {
    for (int i = 0; i < json["answers"].length; i++) {
      correct.add(json["answers"][i]["isTrue"] == 1 ? true : false);
      selected.add(false);
    }
    return QuestionBean(
        title: json['question_title'] as String,
        type: json['type'] as String,
        answers: (json['answers'] as List)
            ?.map((e) => e == null
                ? null
                : AnswerBean.fromJson(
                    e as Map<String, dynamic>, json['type'], correct, selected))
            ?.toList());
  } else {
    return QuestionBean(
        title: json['question_title'] as String,
...
AnswerBean _$AnswerBeanFromJson(Map<String, dynamic> json, String type,
    List<bool> correct, List<bool> selected) {
  if (type == "multi_choice") {
    return AnswerBean(
        text: json["text"] as String,
        listCorrect: correct,
        selectedValueCheckbox: selected);
  } else {
    return AnswerBean(
      text: json['text'] as String,
      isTrue: json['isTrue'] as int,
    );
  }
}
