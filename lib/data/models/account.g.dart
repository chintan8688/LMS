...
Account _$AccountFromJson(Map<String, dynamic> json) {
  return Account(
    ...
    metabean: json['meta'] == null
        ? null
        : MetaBeans.fromJson(json['meta'] as Map<String, dynamic>),
...
MetaBeans _$MetaBeanFromJson(Map<String, dynamic> json) {
  return MetaBeans(
    phone: json['phone'] as String,
    phoneCode: json['phone_code'] as String,
    country: json['country'] as String,
    bDate: json['birth_date'] as String,
    f_name: json['first_name'] as String,
    l_name: json['last_name'] as String,
  );
}
