...
import 'package:masterstudy_app/ui/bloc/book_bookmark/bloc.dart';
...
import 'package:masterstudy_app/ui/bloc/lesson_audio/bloc.dart';
...
import 'package:masterstudy_app/ui/screen/book_details/course_screen.dart';
...
class MyApp extends StatefulWidget {
  final Provider<SignUpScreen> signUpScreen;
  final Provider<LoginScreen> loginScreen;
  final Provider<HomeScreen> homeScreen;
  ...
  final Provider<BookScreen> bookScreen;

  //final Provider<BookDetail> bookDetail;
  final Provider<BookSection> bookSection;
  final Provider<WelcomeScreen> welcomeScreen;
  final Provider<BookBlock> bookBloc;
  final Provider<BookDetailBlock> bookDetailBloc;

  //final Provider<BookSearchDetailScreen> bookSearchDetailScreen;
  final Provider<BookSearchDetailBloc> bookSearchDetailBloc;
  final Provider<RootWelcomeScreen> rootWelcomeScreen;
  final Provider<QuoteScreen> quoteScreen;
  final Provider<DonateScreen> donateScreen;
  final Provider<SettingScreen> settingScreen;
  final Provider<ProfileScreen> profileScreen;
  final Provider<BooksBookmark> booksBookmark;
  final Provider<AboutUs> aboutUs;
  final Provider<InstagramFeed> instagramFeed;
  final Provider<FeedRepository> feedRepository;
  final Provider<FeedBlock> feedBlock;
  final Provider<AboutUsBloc> aboutUsBloc;
  final Provider<AboutUsRepository> aboutUsRepository;
  final Provider<QuoteBloc> quoteBloc;
  final Provider<QuoteRepository> quoteRepository;
  final Provider<FeedDetailScreen> feedDetail;
  final Provider<SettingBloc> settingBloc;
  final Provider<SettingRepository> settingRepository;
  final Provider<BookBookmarkBloc> bookmarkBloc;
  final Provider<LessonAudioBloc> lessonAudioBloc;
  ...
  const MyApp(
    ...
    this.bookBloc,
    this.bookDetailBloc,
    //this.bookSearchDetailScreen,
    this.bookSearchDetailBloc,
    this.rootWelcomeScreen,
    this.quoteScreen,
    this.donateScreen,
    this.settingScreen,
    this.profileScreen,
          ...
          onGenerateRoute: (routeSettings) {
            switch (routeSettings.name) {
              ...
              case CoursesScreen.routeName:
                return MaterialPageRoute(
                    builder: (context) =>
                        CoursesScreen(widget.userCoursesBloc()),
                    settings: routeSettings);
              ...
              case BookScreen.routeName:
                return MaterialPageRoute(
                    builder: (context) => widget.bookScreen(),
                    settings: routeSettings);
              /*case BookDetail.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.bookDetail());*/
              case BookSection.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.bookSection());
              case WelcomeScreen.routeName:
                return MaterialPageRoute(
                    builder: (context) => widget.welcomeScreen(),
                    settings: routeSettings);
              /*case BookSearchDetailScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.bookSearchDetailScreen());*/
              case RootWelcomeScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.rootWelcomeScreen());
              case QuoteScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.quoteScreen());
              case DonateScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.donateScreen());
              case SettingScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.settingScreen());
              case ProfileScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.profileScreen());
              case BooksBookmark.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.booksBookmark());
              case AboutUs.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.aboutUs());
              case InstagramFeed.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.instagramFeed());
              case FeedDetailScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) => widget.feedDetail());
              case LessonAudioScreen.routeName:
                return MaterialPageRoute(
                    settings: routeSettings,
                    builder: (context) =>
                        LessonAudioScreen(widget.lessonAudioBloc()));
              case BookCourseScreen.routeName:
                return MaterialPageRoute(
                    builder: (context) => BookCourseScreen(widget.courseBloc()),
                    settings: routeSettings);
              default:
                return MaterialPageRoute(
                    builder: (context) => widget.splashScreen());
