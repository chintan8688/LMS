...
class BookGridItem extends StatelessWidget {
  ...
  _buildCard(context) {
    ...
    double imgHeight =
        (MediaQuery.of(context).size.width > 450) ? 220.0 : 200.0;
    ...
    return Padding(
        ...
        child: Stack(
          children: <Widget>[
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 8, bottom: 3, right: 3),
                        height: 25,
            ...
            /*Visibility(
                visible: bookBean.isPremium == "1" ? true : false,
                child: Positioned(
                    top: 20.0,
                    right: 0.0,
                    child: Container(
