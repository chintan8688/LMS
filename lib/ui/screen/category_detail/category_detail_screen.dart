...
class CategoryDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<CategoryDetailBloc>(
        create: (c) => _bloc, child: _CategoryDetailScreenWidget());
  }
}
...
class _CategoryDetailScreenWidgetState
    extends State<_CategoryDetailScreenWidget> {
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: CircleAvatar(
                        ...
                        child: Center(
                          child: Text(
                            replaceFarsiNumber(state.courses.length.toString()),
  ...
  _buildTitleDropDown(CategoryDetailState state) {
    ...
    if (state is LoadedCategoryDetailState) {
      var course =
          state.categoryList.where((element) => element.id == selectedId);
