...
class _CurriculumWidgetState extends State<CurriculumWidget>
  ...
  _buildLesson(BuildContext context, CurriculumBean curriculumBean) {
    Widget icon = Center();
    if (curriculumBean.view == "audio")
      icon = SizedBox(
          width: 24,
          height: 24,
          child: SvgPicture.asset(
            "assets/icons/ico_music.svg",
    ...
    if (curriculumBean.view == "text" || curriculumBean.view == "" || curriculumBean.view == null)
      icon = SizedBox(
          width: 24,
          height: 24,
          child: SvgPicture.asset(
