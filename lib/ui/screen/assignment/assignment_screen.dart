...
class AssignmentScreenArgs {
  ...
  AssignmentScreenArgs(
      this.courseId, this.assignmentId, this.authorAva, this.authorName);
}
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<AssignmentBloc>(
        ...
        child: _AssignmentScreenWidget(
            args.courseId, args.assignmentId, args.authorAva, args.authorName));
  }
}
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments:
                              QuestionsScreenArgs(widget.assignmentId, 1),
                        );
                      },
      ...
      switch (state.assignmentResponse.status) {
        case "new":
          return AssignmentPreviewWidget(
              state.assignmentResponse, widget.courseId, widget.assignmentId);
        case "unpassed":
        ...
        case "draft":
          return AssignmentDraftWidget(
              ...
              widget.courseId,
              widget.assignmentId,
              state.assignmentResponse.draft_id);
        case "pending":
        ...
        child: Row(
          ...
          children: <Widget>[
                          ...
                          case "video":
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: LessonVideoScreenArgs(
                                  widget.courseId,
                                  int.tryParse(
                                      state.assignmentResponse.prev_lesson),
                                  widget.authorAva,
                                  widget.authorName,
                                  false,
                                  true),
            ...
            MaterialButton(
              ...
              onPressed: () {
                _bloc.add(
                    StartAssignmentEvent(widget.courseId, widget.assignmentId));
              },
              child: setUpButtonChild(
                  (state is LoadedAssignmentState)
                      ? state.assignmentResponse.button
                      : "",
                  state is LoadedAssignmentState),
            ),
            SizedBox(
                          ...
                          case "video":
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: LessonVideoScreenArgs(
                                  widget.courseId,
                                  int.tryParse(
                                      state.assignmentResponse.next_lesson),
                                  widget.authorAva,
                                  widget.authorName,
                                  false,
                                  true),
            ...
            Expanded(
              ...
              child: MaterialButton(
                  ...
                  child: (!assignmentAdd)
                      ? Text(
                          localizations
                              .getLocalization("assignment_send_button"),
                          textDirection: TextDirection.rtl,
                          textScaleFactor: 1.0,
                        )
