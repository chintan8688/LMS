...
class _FinalScreenState extends State<_FinalScreenWidget> {
  ...
  void initState() {
    super.initState();
    _bloc = BlocProvider.of<FinalBloc>(context)
      ..add(FetchEvent(widget.course_id));
  }
          ...
          Padding(
              ...
              child: Text(
                (state.finalResponse.course_completed)
                    ...
                    : "You have NO completed the course",
                textScaleFactor: 1.0,
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 15.0, color: HexColor.fromHex("#2A3045")),
              )),
          Padding(
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color: HexColor.fromHex("#EEF1F7"), width: 1),
                          borderRadius: BorderRadius.circular(10.0)),
                      child: _buildProgressBar(
                          state, state.finalResponse.course.progress_percent)),
                ),
                Positioned(
                  top: 0.0,
                  child: _buildProgressTitle(
                      state, state.finalResponse.course.progress_percent),
                )
              ],
            ),
  ...
  _buildCard(FinalState state, String ico, String icoHexColor, String title,
      String value) {
    if (state is InitialFinalState) {
      return Center(
        child: CircularProgressIndicator(),
    ...
    if (state is LoadedFinalState) {
      return Padding(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                border:
                    Border.all(color: HexColor.fromHex("#EEF1F7"), width: 1),
                borderRadius: BorderRadius.circular(10.0)),
            child: Padding(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                ...
                textScaleFactor: 1.0,
                style: TextStyle(
                    color: HexColor.fromHex("#AAAAAA"), fontSize: 14.0),
              ),
            ),
            SizedBox(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: () {
                        _downloadCertificate(
                            state.finalResponse.certificate_url);
                      },
                      child: Text(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments: ReviewWriteScreenArgs(
                              state.finalResponse.course.course_id,
                              state.finalResponse.title),
                        );
                      },
                      child: Text(
