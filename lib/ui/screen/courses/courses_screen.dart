...
class CoursesScreen extends StatelessWidget {
  ...
  CoursesScreen(this._bloc) : super();

  @override
  Widget build(BuildContext context) {
    return BlocProvider<UserCoursesBloc>(
        create: (c) => _bloc, child: _CoursesWidget());
  }
}
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            textScaleFactor: 1.0,
            style: TextStyle(color: HexColor.fromHex("#2f3c6e"), fontSize: 18),
          ),
          Padding(
...
class _CourseWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String category = "";
    if (postsBean.categories_object != null &&
        postsBean.categories_object.isNotEmpty) {
                    ...
                    child: ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          valueColor: new AlwaysStoppedAnimation(mainColor),
                        ),
                      ),
                    ),
                  ),
