...
class LessonStreamScreenArgs {
  ...
  LessonStreamScreenArgs(
      this.courseId, this.lessonId, this.authorAva, this.authorName);
}
...
class LessonStreamScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final LessonStreamScreenArgs args =
        ModalRoute.of(context).settings.arguments;

    return BlocProvider<LessonStreamBloc>(
        create: (c) => _bloc,
        child: _LessonStreamScreenWidget(
            args.courseId, args.lessonId, args.authorAva, args.authorName));
  }
}
...
class _LessonStreamScreenWidget extends StatefulWidget {
  ...
  const _LessonStreamScreenWidget(
      this.courseId, this.lessonId, this.authorAva, this.authorName);
          ...
          return Scaffold(
            ...
            appBar: AppBar(
                ...
                actions: <Widget>[
                  Padding(
                    padding:
                        EdgeInsets.only(top: 8.0, bottom: 8.0, right: 15.0),
                    child: SizedBox(
                      width: 42,
                      height: 30,
                      child: FlatButton(
              ...
              Expanded(
                ...
                child: Padding(
                    ...
                    child: MaterialButton(
                        ...
                        child: Text(
                          localizations
                              .getLocalization("complete_lesson_button"),
                          textScaleFactor: 1.0,
                          style: TextStyle(fontSize: 14.0),
                        ))),
              ),
