...
class UserCourseWidgetState extends State<UserCourseWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    num kef = (MediaQuery.of(context).size.height > 690) ? 3.3 : 2.5;
  ...
  Widget _buildLesson(Section_itemsBean section_itemsBean) {
    ...
    if (section_itemsBean.type == "audio")
      icon = SizedBox(
          width: 24,
          height: 24,
          child: SvgPicture.asset("assets/icons/ico_music.svg",
              color: (!locked)
                  ? mainColor
    ...
    if (section_itemsBean.type == "text" || section_itemsBean.type == "" || section_itemsBean.type == "lesson")
      icon = SizedBox(
          width: 24,
          height: 24,
