...
class QuestionsWidgetState extends State<QuestionsWidget> {
  ...
  void initState() {
    ...
    _bloc = BlocProvider.of<QuestionsBloc>(context)
      ..add(FetchEvent(widget.lessonId, widget.page, "", ""));
  }
                  ...
                  bottom: ColoredTabBar(
                      ...
                      TabBar(
                        ...
                        tabs: [
                          Tab(
                            text:
                                localizations.getLocalization("all_questions"),
                          ),
                          Tab(
                              text: localizations
                                  .getLocalization("my_questions")),
                        ],
                      )),
                ),
                ...
                SizedBox(
                    ...
                    child: SvgPicture.asset(
                      (question.replies.length == 0)
                          ? "assets/icons/reply_no.svg"
                          : "assets/icons/reply_has.svg",
                      color: (question.replies.length == 0)
                          ? HexColor.fromHex("#AAAAAA")
                          : secondColor,
                    )),
                Padding(
              ...
              Padding(
                  ...
                  child: TextFormField(
                    ...
                    onFieldSubmitted: (text) {
                      _bloc.add(MyQuestionAddEvent(
                          questionsAll,
                          widget.lessonId,
                          text,
                          int.tryParse(question.comment_ID)));
                    },
